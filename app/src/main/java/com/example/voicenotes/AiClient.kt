...
object AiClient {
    ...
    private fun allVariantsPrompt(): String {
        ...
        sb.append("сохранив КАЖДОЕ предложение и КАЖДУЮ мысль оригинала. Разрешено ТОЛЬКО: ")
        sb.append("исправить ошибки распознавания (окончания, падежи, созвучные слова), убрать ")
        sb.append("дословные повторы-заики, расставить пунктуацию и границы предложений СВОБОДНО ")
        sb.append("ПО СМЫСЛУ (не ориентируйся на паузы распознавания — они часто ошибочны; ")
        sb.append("объединяй обрывки в цельные предложения там, где это логично). ЗАПРЕЩЕНО: ")
        sb.append("выкидывать предложения, сокращать, пересказывать. Все факты и слова сохрани.\n")
