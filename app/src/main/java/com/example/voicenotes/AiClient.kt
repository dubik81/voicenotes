...
object AiClient {
    ...
    private fun allVariantsPrompt(): String {
        ...
        sb.append("дословные повторы-заики (например «проверим ... проверим» → одно «проверим»), ")
        sb.append("расставить пунктуацию и заглавные. ЗАПРЕЩЕНО: выкидывать предложения, сокращать, ")
        sb.append("пересказывать, объединять мысли. Если в оригинале 3 предложения — в ответе ТОЖЕ ")
        sb.append("должны быть все 3. Длина ≈ длине оригинала (НЕ короче существенно).\n")
